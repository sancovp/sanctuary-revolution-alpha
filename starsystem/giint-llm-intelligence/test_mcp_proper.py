#!/usr/bin/env python3
"""
Direct tool call test for LLM Intelligence MCP using mcp-use
...
async def test_llm_intelligence_mcp():
    ...
    try:
        ...
        print(f"✓ Second response created: {result}")
        ...
        print(f"✓ Read response {response['response_num']}")
        ...
        print(f"✓ Session completed: {complete['message']}")
