#!/usr/bin/env python3
"""CLI for my-domain-treeshell TreeShell Factory"""
...
def main():
    parser = argparse.ArgumentParser(description="Generate TreeShell library from my-domain-treeshell")
    ...
    if not args.description:
        args.description = f"TreeShell library based on my-domain-treeshell"
    
    factory = RecursiveTreeShellFactory(
        base_library="my_domain_treeshell",
