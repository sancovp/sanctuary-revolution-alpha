...
class YOUKNOW:
    """
    The homoiconic kernel. BUILT ON Category of Categories.
    
    YOUKNOW IS_A Category, PART_OF Cat_of_Cat.
    All operations go through cat_of_cat.
    
    This is NOT a wrapper. Cat of Cat IS the ontology.
    YOUKNOW provides the interface to it.
