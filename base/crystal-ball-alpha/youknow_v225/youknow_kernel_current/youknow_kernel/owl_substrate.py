...
class OWLWriter:
    ...
    def __init__(
        ...
        if domain:
            self.domain_file = os.path.join(owl_dir, f"{domain}.owl")
        else:
...
class DualSubstrate:
    ...
    def __init__(
        ...
        self.owl = OWLWriter(owl_dir, domain_file, domain=domain)
    ...
    def add_entity(self, entity: OWLEntity) -> Dict[str, Any]:
        ...
        # Mirror DISABLED — CartON is primary store, calls INTO YOUKNOW for validation.
        # DualSubstrate mirror was for standalone YOUKNOW without CartON on top.
        # With CartON on top, this creates infinite requeue loop (Bug_May6).
        carton_result = "Mirror disabled — CartON is primary store"
