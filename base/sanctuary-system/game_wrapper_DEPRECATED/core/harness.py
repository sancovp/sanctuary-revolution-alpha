...
# Import OmnisancState from agent (agent HAS state, harness routes events)
from .agent import OmnisancState
...
class PAIAHarness:
    ...
    def __init__(self, config: Optional[HarnessConfig] = None):
        ...
        # Omnisanc state reflection
        self.omnisanc = OmnisancState.load()
    ...
    def inject(self, messages: list[str]):
        ...
        # CONNECTS_TO: /tmp/paia_injection.txt (write) — read by paia_* hooks in ~/.claude/hooks/
