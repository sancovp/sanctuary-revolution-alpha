#!/usr/bin/env python3
"""
HEAVEN Extraction Patterns Example - Final Working Version
...
Use these exact section names. This is mandatory.""",
        ...
        model="o4-mini",
        temperature=0.3,
        # Don't set max_tokens - let it use defaults
...
confidence: Numerical confidence rating"""
    ...
    goal = "Analyze remote work trends and provide structured output with summary, key points, recommendations, and confidence score"
