...
export function getN8nApiConfig() {
  ...
  // Check if URL is provided (API key optional for local instances)
  ...
  return {
    ...
    apiKey: config.N8N_API_KEY, // Optional - undefined for local unauthenticated instances
...
export function getN8nApiConfigFromContext(context: {
  ...
  return {
    ...
    apiKey: context.n8nApiKey, // Optional for local instances
