...
from observatory.agents import make_grug_sdnac, make_researcher_sdnac
from observatory.config import GRUG_MODEL, RESEARCHER_MODEL


class TestMakeGrugSdnac:
    @patch("observatory.agents.sdnac")
    @patch("observatory.agents.ariadne")
    @patch("observatory.agents.default_config")
